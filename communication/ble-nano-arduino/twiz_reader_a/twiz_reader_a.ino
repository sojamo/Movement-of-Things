...
//  connParams->minConnectionInterval = 1250;
//  connParams->maxConnectionInterval = 1400;
//  connParams->slaveLatency = 4;
//  connParams->connectionSupervisionTimeout = 550;
...
//  connParams->connectionSupervisionTimeout = 550;
//
//  ble.setPreferredConnectionParams(connParams);
//  ble.updateConnectionParams(params->handle, connParams);
...
void setup() {
  ...
  Gap::ConnectionParams_t new_params;
  new_params.minConnectionInterval = 1250;
  new_params.maxConnectionInterval = 1400;
  new_params.slaveLatency = 4;
  new_params.connectionSupervisionTimeout = 550;
